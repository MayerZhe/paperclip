# Releasing Super Node

Maintainer runbook for shipping Super Node across npm, GitHub, and the website-facing changelog surface.
...
Super Node uses calendar versions that still fit semver syntax:
