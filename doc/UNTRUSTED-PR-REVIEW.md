...
This is intentionally separate from the normal Super Node dev image.
...
## Preview the Super Node app from the PR
...
- Super Node's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.paperclip-review`.
