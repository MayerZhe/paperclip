...
This document covers the GitHub and npm setup required for the current Super Node release model:
...
Do this for every public package that Super Node publishes.
...
2. revoke any personal automation token that used to publish Super Node
