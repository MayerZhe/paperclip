...
3. Super Node copies that output into a higher-trust assignee wake
...
- Repo workspace content itself remains hostile; this contract narrows Super Node API authority, not the semantic risk of reading bad code.
