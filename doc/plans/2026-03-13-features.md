...
- Team of 3 can use one shared Super Node instance.
...
Super Node should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
- A chat plugin can converse without requiring chat to become the core Super Node product.
...
- **Keep** Super Node as the board-level control plane.
