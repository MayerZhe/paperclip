# Super Node Skill Tightening Plan
...
- preserve all current Super Node control-plane capabilities
...
- changing Super Node API semantics
...
- add at least lightweight eval or scripted scenario coverage for key Super Node flows
- confirm how adapter/bootstrap layering should load skill content versus references

## Success Criteria

- materially lower first-run input tokens for Super Node-coordinated agents
