...
This note inventories the Super Node issues that point to the same UX class of problem:
...
Pattern: Super Node already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
