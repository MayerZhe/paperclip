...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/Super Node-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - Super Node may create host-local worktrees, processes, and paths
- `cloud`
  - Super Node should assume no durable host-local execution workspace management
