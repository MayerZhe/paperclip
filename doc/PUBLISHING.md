...
Low-level reference for how Super Node packages are prepared and published to npm.
...
Super Node no longer uses release branches or Changesets for publishing.
...
Super Node uses calendar versions:
...
Super Node does not auto-publish every non-private workspace package anymore.
