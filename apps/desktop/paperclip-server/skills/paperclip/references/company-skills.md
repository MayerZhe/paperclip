...
- App-shipped catalog: a curated set of company skills in `@paperclipai/skills-catalog`, browseable and installable without leaving Super Node.
...
- Built-in Super Node runtime skills are still added automatically when required by the adapter.
