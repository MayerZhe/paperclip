...
Super Node organizes autonomous AI work around six key concepts.
...
One Super Node instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by Super Node.
