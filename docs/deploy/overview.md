...
Super Node supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Super Node?** Use `local_trusted` (the default)
