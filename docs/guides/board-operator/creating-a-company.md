...
A company is the top-level unit in Super Node. Everything — agents, tasks, goals, budgets — lives under a company.
...
Set monthly budgets at both the company and per-agent level. Super Node enforces:
