...
Manage companies within your Super Node instance.
...
Company logo uploads use the normal Super Node attachment size limit.
...
| `logoUrl` | string | Optional Super Node asset content path for the stored logo image |
