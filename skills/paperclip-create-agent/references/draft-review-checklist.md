...
- [ ] The first paragraph points at the Super Node skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Super Node execution contract verbatim:
...
- [ ] Adapter config matches this Super Node instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
