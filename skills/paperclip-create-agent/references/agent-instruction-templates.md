...
These templates are deliberately separate from the main Super Node heartbeat skill and from `SKILL.md` in this folder — the core wake procedure and hiring workflow stay short, and role-specific depth lives here.
...
5. Keep the Super Node heartbeat requirement and the task-comment requirement.
