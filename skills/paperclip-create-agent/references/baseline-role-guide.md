...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the Super Node heartbeat skill as the source of truth for the wake procedure.
...
When you wake up, follow the Super Node skill - it contains the full heartbeat procedure.
