...
import { Download, ExternalLink, FileText, Paperclip as PaperclipIcon, Trash2 } from "lucide-react";
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          <PaperclipIcon className="h-3.5 w-3.5 text-muted-foreground" aria-hidden="true" />
