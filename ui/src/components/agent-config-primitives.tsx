...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "How Super Node should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when Super Node starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Super Node adds its standard wake and workspace fields.",
