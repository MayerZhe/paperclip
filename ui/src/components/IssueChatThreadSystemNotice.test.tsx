...
describe("IssueChatThread system notice routing", () => {
  ...
  it("labels system notice source as Super Node when no run agent can be resolved", () => {
    const comment: IssueChatComment = {
  ...
  it("falls back to Super Node in the system notice header when run agent is unknown to agentMap", () => {
    const comment: IssueChatComment = {
