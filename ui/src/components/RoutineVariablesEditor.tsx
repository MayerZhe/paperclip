      ...
      <Dialog open={helpOpen} onOpenChange={setHelpOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>
              How to prompt for inputs and which variables Super Node fills in automatically.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-5 text-sm">
            <section className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                anywhere in the title or instructions. Super Node detects each placeholder, lists it
