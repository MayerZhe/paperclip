...
describe("issue-reference", () => {
  ...
  it("does not treat GitHub issue URLs as internal Super Node issue links", () => {
  ...
  it("preserves absolute Super Node issue URLs so origin, port, and hash are not lost", () => {
