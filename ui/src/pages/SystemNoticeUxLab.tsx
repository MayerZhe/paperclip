        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="p-6 sm:p-7">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              Replaces the current pattern where a Super Node-authored warning renders inside a user-style
      ...
      >
        <div className="space-y-4 rounded-2xl border border-border/70 bg-background/70 p-4">
          ...
          <SystemNotice
            tone="danger"
            label="System alert"
            source={{ label: "Super Node", href: "/PAP/agents" }}
            timestamp="2026-05-04T16:48:00.000Z"
            body="Super Node could not resolve this issue's missing disposition automatically. The issue is blocked on a recovery owner."
            metadata={[
              {
        ...
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            ...
            <p className="px-1 text-xs text-muted-foreground">
              ...
              author is the Super Node system. Two containers stack the warning inside a user-style
