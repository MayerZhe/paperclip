...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Super Node secret", async () => {
    ...
    expect(document.body.textContent?.toLowerCase()).toContain("a super node secret already uses this");
