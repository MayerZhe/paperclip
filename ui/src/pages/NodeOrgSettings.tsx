...
export function NodeOrgSettings() {
  const {
    companies,
    selectedCompany,
    selectedCompanyId,
  ...
  if (!selectedCompany) {
    return (
      <div className="text-sm text-muted-foreground">
        No node org selected. Select a node org from the switcher above.
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-lg font-semibold">Node Org Settings</h1>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <Field label="Node Org Name" hint="The display name for your node org.">
            <input
          ...
          <Field
            label="Description"
            hint="Optional description shown in the node org profile."
          >
            <input
              className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
              type="text"
              value={description}
              placeholder="Optional node org description"
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              <Field
                label="Brand color"
                hint="Sets the hue for the node org icon. Leave empty for auto-generated color."
              >
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={brandColor || "#a855f7"}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-destructive/40 bg-destructive/5 px-4 py-4">
          <p className="text-sm text-muted-foreground">
            Archive this node org to hide it from the sidebar. This persists in
            the database.
          </p>
          <div className="flex items-center gap-2">
            <Button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  `Archive node org "${selectedCompany.name}"? It will be hidden from the sidebar.`
                );
                if (!confirmed) return;
                const nextCompanyId =
                  companies.find(
