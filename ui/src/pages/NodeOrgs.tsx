...
export function NodeOrgs() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: "Node Orgs" }]);
  }, [setBreadcrumbs]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">Loading node orgs...</p>}
              ...
              {isConfirmingDelete && (
                ...
                >
                  <p className="text-sm text-destructive font-medium">
                    Delete this node org and all its data? This cannot be undone.
                  </p>
