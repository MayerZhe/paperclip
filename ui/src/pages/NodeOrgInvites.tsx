...
export function NodeOrgInvites() {
  ...
  if (!selectedCompanyId) {
    return <div className="text-sm text-muted-foreground">Select a Node Org to manage invites.</div>;
  }
    ...
    <div className="max-w-5xl space-y-8">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Node Org Invites</h1>
        </div>
        <p className="max-w-3xl text-sm text-muted-foreground">
          Invite people to request access to this node org. New invite links are copied to your clipboard when they are generated.
        </p>
      </div>
