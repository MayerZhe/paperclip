...
export function NodeOrgEnvironments() {
  ...
  if (!selectedCompanyId) {
    return <div className="text-sm text-muted-foreground">Select a Node Org to manage environments.</div>;
  }
    ...
    return (
      <div className="max-w-3xl space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Node Org Environments</h1>
        </div>
        <div className="rounded-md border border-border px-4 py-4 text-sm text-muted-foreground">
          Enable Environments in instance experimental settings to manage node org execution targets.
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-4 rounded-md border border-border px-4 py-4">
        ...
        <div className="space-y-3">
          {(environments ?? []).length === 0 ? (
            <div className="text-sm text-muted-foreground">No environments saved for this node org yet.</div>
          ) : (
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="space-y-1">
                      ...
                      {environment.driver === "ssh" ? (
                        ...
                        <div className="text-xs text-muted-foreground">Runs on this Super Node host.</div>
                      )}
                    </div>
          ...
          <div className="space-y-3">
            ...
            {environmentForm.driver === "ssh" ? (
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <Field label="Remote workspace path" hint="Absolute path that Super Node will verify during SSH connection tests.">
                  <input
                    className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
                    type="text"
