...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The Super Node CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Approve Super Node CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local Super Node CLI process is requesting board access to this instance.
        </p>
        ...
        <div className="mt-5 space-y-3 text-sm">
          ...
          {challenge.requestedCompanyName && (
            <div>
              <div className="text-muted-foreground">Requested node org</div>
