  ...
  return (
    <div className="mt-6 border-t border-border pt-5">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        {hasActiveInvite
          ? "A bootstrap invite is already active. Check your Super Node startup logs for the first‑admin URL, or run this command on the host to rotate it:"
          : "Run this command on the host that runs Super Node to print a one‑time first‑admin invite URL:"}
      </p>
...
function SignedOutPrivate() {
  return (
    <StateChrome>
      <h1 className="text-xl font-semibold">Finish setting up this Super Node</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        No admin has claimed this instance yet. Sign in or create your Super Node account to become the first
    ...
    <StateChrome>
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Setup is complete. Taking you to onboarding to create your first node org&hellip;
          </p>
        </div>
      </div>
...
function PublicInviteOnly() {
  return (
    <StateChrome>
      <h1 className="text-xl font-semibold">This Super Node is waiting on its first admin</h1>
      <p className="mt-2 text-sm text-muted-foreground">
