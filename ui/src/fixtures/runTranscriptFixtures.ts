...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    text: "I’m starting with the Super Node heartbeat procedure and the repo-required docs so I can see what task is actually assigned and then work only on that scope.",
  },
  {
    kind: "tool_call",
  ...
  },
  {
    ...
    toolUseId: "item_1",
    content: "command: sed -n '1,220p' doc/GOAL.md\nstatus: completed\nexit_code: 0\n\n# Super Node\n\nSuper Node is the backbone of the autonomous economy.",
    isError: false,
  },
  {
    kind: "tool_result",
