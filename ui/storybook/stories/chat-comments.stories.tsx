...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Super Node work: checkout, comments, linked runs, and review feedback.",
      ...
      <main className="paperclip-story__inner space-y-6">
        <section className="paperclip-story__frame p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Super Node operational content with mixed authors, system timeline events,
