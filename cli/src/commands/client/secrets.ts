...
export function registerSecretCommands(program: Command): void {
  ...
  addCommonClientOptions(
    secrets
      .command("create")
      .description("Create a Super Node-managed secret")
      .requiredOption("-C, --company-id <id>", "Company ID")
  ...
  addCommonClientOptions(
    secrets
      .command("link")
      .description("Link an external provider-owned secret without storing its value in Super Node")
      .requiredOption("-C, --company-id <id>", "Company ID")
      .requiredOption("--name <name>", "Secret display name")
  ...
  addCommonClientOptions(
    secrets
      .command("rotate")
      .description("Rotate a Super Node-managed secret value")
      .argument("<secretId>", "Secret ID")
  ...
  addCommonClientOptions(
    secrets
      .command("doctor")
      .description("Run secret provider health checks through the Super Node API")
      .requiredOption("-C, --company-id <id>", "Company ID")
