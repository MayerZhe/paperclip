...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update Super Node work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update Super Node work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update Super Node work for an agent using board auth")
